<template>
    <media-modal v-if="$store.state.showUploadMediaModal" :size="'md'" @close="close()" label-element="uploadMediaTitle">
        <h3 slot="header" id="uploadMediaTitle" class="modal-title">{{ translate('COM_MEDIA_CREATE_NEW_FOLDER') }}</h3>
        <div slot="body">
