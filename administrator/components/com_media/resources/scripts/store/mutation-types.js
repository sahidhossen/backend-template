...
// Upload media modal
export const HIDE_UPLOAD_MEDIA_MODAL = 'HIDE_UPLOAD_MEDIA_MODAL';
export const SHOW_UPLOAD_MEDIA_MODAL = 'SHOW_UPLOAD_MEDIA_MODAL';
// Set last uploaded file
export const SET_LAST_UPLOADED_FILES = 'SET_LAST_UPLOADED_FILES';
